                    ...
                    // if (d.size) -- d.size > 0 when d is a group node.
                        ...
                        .on("mouseover", function (d) {
                            ...
                            if (d.id) {
                                ...
                                div5.html('Node: ' +
                                    '<text class = "bold" style="color: ' + getColor(d.type).toString() + '"> ' + d.id + "</text>" +
                                    "<br/> Type: " +
                                    '<text class = "bold" style="color: ' + getColor(d.type).toString() + '"> '  + d.type + "</text>"
                                )
                                ...
                                div5.html('Node: ' +
                                    '<text class = "bold" style="color: ' + getColor(d.nodes[0].type).toString() + '"> '  + d.nodes[0].id + "</text>" +
                                    "<br/> Type: " +
                                    '<text class = "bold" style="color: ' + getColor(d.nodes[0].type).toString() + '"> '  + d.nodes[0].type + "</text>"
                                )
                                    .style("left", (d3.event.pageX) + 10 + "px")
                                    .style("top", (d3.event.pageY - 20) + "px")
                                    .style("pointer-events", "none")
